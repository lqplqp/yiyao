...
public class ShiJiPeiXunMessageSearchAdapter extends MBaseAdapter<ShiJiPeiXunMessageSearchAdapter.ViewHolder> {




    public ShiJiPeiXunMessageSearchAdapter(String bean) {
        super(bean);
    }
    ...
    protected void fillData(int i, ViewHolder holder, JSONObject result) {
        ...
        //创建时间
        holder.chuangjianshijian.setText("cjsj");
        //发布状态
        holder.fabuzhuangtai.setText("fbzt");
    }
