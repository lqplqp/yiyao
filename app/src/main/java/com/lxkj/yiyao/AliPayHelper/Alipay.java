package com.lxkj.yiyao.AliPayHelper;
    ...
    public void doPay() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //Log.e("FairyDebug","支付结果:"+pay_result);
