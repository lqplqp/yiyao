...
public class GeRenYongHuYingYongChaJianXiaZaiAdapter extends MBaseAdapter<GeRenYongHuYingYongChaJianXiaZaiAdapter.ViewHolder> {
    ...
    public GeRenYongHuYingYongChaJianXiaZaiAdapter(String bean) {
        super(bean);
    }
